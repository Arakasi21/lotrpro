...
{{--                    <img  width="200px" height="200" src="https://www.pngall.com/wp-content/uploads/12/Lord-Of-The-Rings-Transparent.png" alt="">--}}
                    <img style="  width: 200px;  height: 200px;  border-radius: 50%;   border: 1px solid black;"src="{{Auth::user()->imagePath}}" alt="">
                    <div class="">
                ...
                <div class="col-9 indexprofileback" style="background-color: #D3AC6E;">
    ...
    <section style="margin-top: 30px;">
            ...
            <hr class="style-eight">
            <h2 style="color:#ffc500">My Orders</h2>
